...
Run the following from the same directory as the tumbling_windows.py file downloaded from course materials
...
6) In another terminal / cmd prompt (with the Python Virtual Environment activated) run the Flink program tumbling_windows.py

To run the Table API version:

python tumbling_windows.py


To run the SQL Interface version:

python tumbling_windows_sql.py
